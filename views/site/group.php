...
<ol class="w-50">
    ...
    foreach ($groups as $group) {
        echo '<li class="border border-primary p-2"><div class="d-flex justify-content-evenly align-items-center"><div class="p-2 w-25"> ' . $group->name . ' </div><div class="p-2 w-25"> ' . $group->getDiscipline() . '</div></div></li>';
    }
    ?>
</ol>